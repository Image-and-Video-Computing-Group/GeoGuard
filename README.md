...
<div align="left"> 
<h1>山川智护GeoGuard 智能减灾知识服务大模型</h1> 
</div> 
...
**GeoGuard** 是首个聚焦于地质灾害风险识别的中文大模型，由电子科技大学未来媒体中心团队研发，依托地质灾害专业知识、多源遥感影像和先进的多模态大模型技术构建。GeoGuard 具备识别滑坡、崩塌、泥石流等多类地质灾害的能力，能够辅助实现灾前风险预判、灾中快速识别与灾后评估等任务。


## 说明  
1. **功能演进**：当前版本 GeoGuard v1.0 支持滑坡、崩塌、泥石流三灾种智能识别与分级预警；
2. **技术架构**：基于 Qwen-7B 的 LoRA 微调文本引擎 + （百亿）参数视觉大模型，实现多模态特征融合与中文地质指令理解；  
